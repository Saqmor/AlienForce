...
void Menu::run_menu(){
    ...
    std::cout << hero.grenades[0].full << std::endl;
    std::cout << hero.grenades[1].full << std::endl;
    std::cout << hero.grenades[2].full << std::endl;
    std::cout << hero.grenades[3].full << std::endl;
